...
/// Equivalence proof against `Resources/geometry-vectors-1.3.0.json` — machine-generated by
/// the Python ctrl-kd 1.3.0 reference for the page-geometry fix ("Page geometry: WordStar's
/// own vertical model for printed capacity"): 19 `parse_ws` cases plus one `parse_printstream`
...
private func loadGeometryVectors() throws -> GeometryVectorFile {
    let url = try #require(
        Bundle.module.url(forResource: "geometry-vectors-1.3.0", withExtension: "json"),
        "geometry-vectors-1.3.0.json missing from the test bundle"
    )
