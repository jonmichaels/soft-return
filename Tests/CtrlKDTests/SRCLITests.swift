...
@Test func versionLineNamesBothTheCLIAndTheReference() {
    ...
    #expect(versionLine(devDate: srDevDate) == "sr 3.2.0 (ctrl-kd parity 4.0.0)")
    #expect(versionLine(devDate: "2026-08-14") == "sr 3.2.0 (dev 2026-08-14) (ctrl-kd parity 4.0.0)")

    let recorder = Recorder()
    #expect(run(["--version"], environment: recorder.environment) == ExitStatus.ok)
    #expect(recorder.out == [versionOutput])
    #expect(versionOutput.hasSuffix("sr 3.2.0 (ctrl-kd parity 4.0.0)"))
