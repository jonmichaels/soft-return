...
**CtrlKD** — a Swift engine for reading WordStar files and turning them back into
...
CtrlKD is a rewrite of [**ctrl-kd**](https://github.com/jonmichaels/ctrl-kd), the Python
...
The library is the foundation. Next:

- **`sr`** — a command-line converter, the Swift counterpart to ctrl-kd's CLI.
- **Soft Return** — a Mac app: open a file from a 1989 floppy, see it rendered, save it as
  something a person can read. Possibly a Quick Look extension, so the Finder can preview
  WordStar files directly.
