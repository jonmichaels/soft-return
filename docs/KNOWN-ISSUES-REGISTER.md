...
- **Stated reason (this session, line 373's guard fired):** "no Release
  build at the expected build output path `build-dd/Build/Products
...
- **Stated reason (quoted, lines 398-402):** "Jon's ruling, 2026-08-19 ('Go
  with A')... the full-corpus truth is the out-of-repo engine sweep (1236/1236
...
- **Retirement condition:** none intended — by design, this repo never
  ...
  repo"); the out-of-repo sweep is the permanent home for this coverage.
